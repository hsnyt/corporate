        ...
        <div className="mb-10 group">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-3">
              <h3 className="text-4xl md:text-6xl font-black mb-4 text-gray-500 group-hover:text-orange-400 transition-colors duration-500">
                Growth Hack
              </h3>
        ...
        <div className="mb-14 group">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <h3 className="text-4xl md:text-6xl font-black mb-4 text-gray-500 group-hover:text-blue-400 transition-colors duration-500">
                Product
              </h3>
              <p className="text-sm text-gray-500 mb-4 tracking-wider">
